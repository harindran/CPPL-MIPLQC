Module modEnum
    ...
    Public BranchFlag As String
    'Public RMLineId, FGLineId, FGLineNO, RMLineNO, ReceiptNo, BDocEntry, BLineId As Integer
    'Public ct, tt As String
    Public GRPOEntries As String = ""
    'Public FinalBatch As String = ""
    'Public TrackBatch As New List(Of String)
    Public TranValue() As String
    Public bModal As Boolean = False
    Public DisposableGoodsIssue As String = ""
    Public TranFlag As Boolean = False
End Module
